...
주소 및 네트워크 목록 상세는 [사전예치 금고 컨트랙트](/home/general-info/contract-addresses/pre-deposit)를 참조하세요.
...
- **Karma**: 양도 불가능한 거버넌스 토큰; 가스리스 처리량과 투표권 부여 (자세한 내용은 [카르마 토크노믹스](/home/tokenomics/karmic-tokenomics) 참조).
...
- [사전예치 금고 컨트랙트](/home/general-info/contract-addresses/pre-deposit) — 배포된 주소 정보
- [카르마 토크노믹스](/home/tokenomics/karmic-tokenomics) — Karma 획득 및 사용 방법
- [경제 모델](/home/tokenomics/economic-model) — Status Network의 지속 가능한 수익 모델
