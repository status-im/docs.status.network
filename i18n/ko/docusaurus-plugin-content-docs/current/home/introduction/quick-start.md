...
1. **Status Network 테스트넷을 MetaMask에 추가**:
   ...
   [Status Network 추가 가이드](/home/general-info/add-status-network)의 단계별 지침에 따라 Status Network 테스트넷을 MetaMask에 추가하세요.
...
- **지원 받기**:
  ...
  - [네트워크 세부정보](/home/general-info/network-details)에서 자세한 정보를 확인하세요
  - Status Network로의 [토큰 브리징](/home/general-info/bridge/bridging-testnet)에 대해 알아보세요
