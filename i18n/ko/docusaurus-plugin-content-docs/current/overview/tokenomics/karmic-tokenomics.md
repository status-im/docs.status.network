---
title: '카르마 토크노믹스: 평판과 거버넌스 파워 획득'
description: '카르마 토크노믹스 안내. 소울바운드 카르마가 거래 처리량, 네이티브 수익 배분, 네트워크 차원의 스팸 슬래싱을 어떻게 관장하는지 알아보세요.'
keywords:
  - '카르마 토큰'
  - '카르마 토크노믹스'
  - 'Status Network 거버넌스'
...
동양의 전통에서 카르마는 과거의 행동이 미래의 상태를 형성한다는 원리를 나타냅니다. 마찬가지로 Status Network에서는 모든 긍정적인 행동과 기여가 카르마를 축적하여 네트워크의 자금 조달과 인센티브에 대한 더 큰 영향력을 부여합니다. 카르마($KARMA)는 스테이킹, 브릿지, 유동성 제공, 구축에 대한 보상을 제공하는 양도 불가능한 거버넌스 토큰입니다. 사용자나 앱이 L2의 유동성이나 활동에 더 많이 기여할수록, 자금 배분, 유동성 인센티브, 네트워크 로드맵과 매개변수에 대한 더 많은 투표권을 얻게 됩니다.

## 카르마 티어

카르마 티어는 각 주소의 가스리스 트랜잭션 할당량을 결정합니다. 티어가 높을수록 에폭당 더 많은 무료 트랜잭션을 사용할 수 있습니다.

### 현재 티어 모델 (테스트넷)

| 티어 | 일일 할당량 | 등가 속도 | Karma 범위 |
|---|---|---|---|
...
:::info 테스트넷 전용
이 티어 모델은 현재 테스트넷 정렬에 사용됩니다. 티어별 정확한 할당량 수치는 향후 카르마 보유자 거버넌스에 따라 달라질 수 있습니다.
:::
...
2. **수익 창출 자산 브릿지** – ETH와 DAI(초기에, 나중에 더 많은 자산이 추가될 예정)를 Status Network에 브릿지하면 카르마를 획득할 수 있습니다.
...
1. 사용자는 수익 창출 자산을 브릿지하여 카르마를 획득하고 앱과 유동성 제공자에 대한 자금을 증가시킵니다.

2. 더 높은 앱 자금이 더 많은 새로운 앱을 네트워크에 배포하도록 유치합니다.

3. 자금을 받은 앱이 더 많은 사용자를 확보하여 네이티브 DEX의 거래량을 증가시킵니다.

4. 더 높은 네이티브 수익과 수수료가 사용자들이 추가 수익 창출 자산을 브릿지함으로써 더 많은 TVL을 유치합니다.
