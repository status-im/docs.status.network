---
title: '공식 링크'
description: 'Status Network 공식 리소스 모음입니다. 메인넷 링크, 브리지 도구, 파우셋, 개발자 커뮤니티 정보를 제공합니다.'
keywords:
  - 'Status Network 링크'
  - '공식 리소스'
  - '네트워크 도구'
...
지갑에 네트워크를 추가하는 방법에 대해서는 [네트워크 추가 가이드](/overview/general-info/add-status-network)를 참조하세요.
