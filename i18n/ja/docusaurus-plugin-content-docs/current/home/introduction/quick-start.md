...
1. **Status NetworkテストネットをMetaMaskに追加**：
   ...
   MetaMaskにStatus Networkテストネットを追加する方法については、[Status Network追加ガイド](/home/general-info/add-status-network)の手順に従ってください。
...
- **サポートを受ける**：
  ...
  - 詳細については[ネットワークの詳細](/home/general-info/network-details)をチェック
  - Status Networkへの[トークンのブリッジ](/home/general-info/bridge/bridging-testnet)について学ぶ
