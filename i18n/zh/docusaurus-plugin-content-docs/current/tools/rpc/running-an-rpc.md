...
有关详细的设置说明、先决条件、系统要求和分步指导，请参阅仓库中的 [**官方 README**](https://github.com/status-im/status-l2-rpc-tools/blob/master/README.md)。
...
- `eth_getLogs`（大范围）：200毫秒至几秒。请使用有界范围和布隆过滤器。
- `eth_estimateGas`：200毫秒至几秒。在负载较高或合约较复杂时可能更慢。
