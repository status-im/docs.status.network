...
完整的地址和网络列表请参阅[预存款金库合约](/overview/general-info/contract-addresses/pre-deposit)。
...
- **Karma**：不可转让的治理代币；授予免 Gas 吞吐量和投票权（详见 [Karmic 代币经济学](/overview/tokenomics/karmic-tokenomics)）。
...
- [预存款金库合约](/overview/general-info/contract-addresses/pre-deposit) — 已部署地址信息
- [Karmic 代币经济学](/overview/tokenomics/karmic-tokenomics) — Karma 的获取和使用方式
- [经济模型](/overview/tokenomics/economic-model) — Status Network 的可持续收入模型
