      ...
      <div className="idea-card__badges">
        <span
          ...
          style={{
            ...
            background: `color-mix(in srgb, ${difficultyColors[idea.difficulty]} 10%, transparent)`,
          }}
        >
      ...
      {expanded && (
        <div className="idea-card__detail" id={detailId} role="region" aria-label={`${idea.title} details`}>
          ...
          <div className="idea-card__detail-meta">
            <MetaBadge
              label={translate({id: 'ideaCatalog.card.security', message: 'Security'})}
              value={securityCriticalityLabels[idea.securityCriticality]}
            />
            <MetaBadge
              label={translate({id: 'ideaCatalog.card.opsBurden', message: 'Ops Burden'})}
              value={opsBurdenLabels[idea.opsBurden]}
            />
          </div>
        </div>
      )}
